        ...
        <div className="flex justify-center w-full h-full selectInterest">
          <div className="content w-1/2 pt-10 h-full relative">
            <div>
              ...
              <span style={{ color: themeColorSet.colorText3 }}>Select commnunities</span>
            </div>
                ...
                return (
                  <div key={index} className="group mt-10">
                    <div
                      ...
                      style={{ color: themeColorSet.colorText2, fontSize: '1.3rem' }}
                    >
                      {item.groupName}
                    </div>
                      ...
                      {item.data.map((item, index) => {
                        return (
                          ...
                          >
                            ...
                            >
                              <ButtonActiveHover rounded>Join</ButtonActiveHover>
                            </div>
                          </div>
                        );
                      })}
